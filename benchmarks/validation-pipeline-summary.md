...
**Total Attempts**: 2  
**Total Pipeline Latency**: 141.53 ms  
...
| :--- | :--- | :--- | :--- | :--- |
| `compile` | `node -e "console.error('src/services/MockService.ts(5,10): error TS2304: Cannot find name MissingType.'); process.exit(1)"` | ❌ FAIL | 60.97 ms | `Stage "compile" failed executing "node -e "console.error('sr` |
